...
import automationImage from "/Automate.png";
  ...
  return (
    <div className="relative border bg-neutral-50 overflow-hidden group h-full p-5 md:p-6 rounded-2xl border-neutral-200 backdrop-blur-xl backdrop-saturate-150 shadow-sm transition-colors duration-300 hover:border-sky-300">
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at ${glowPosition}, rgba(56,189,248,0.16), transparent 80%)`,
        }}
      />
      ...
      <div className="relative flex flex-col h-full">
        ...
        {/* Image */}
        <div className="relative aspect-[1.4/1] w-full overflow-hidden rounded-xl bg-gradient-to-br from-sky-100/60 to-white border border-neutral-200 mb-6 transition-colors duration-300 group-hover:border-sky-200">
        ...
        <p className="mt-2 text-sm md:text-[15px] leading-snug text-neutral-500">
          {desc}
        </p>
